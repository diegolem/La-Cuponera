...
<link href="${pageContext.request.contextPath}/assets/css/materialize.min.css" rel="stylesheet">
...
<script src="${pageContext.request.contextPath}/assets/js/materialize.js" type="text/javascript"></script>
<link href="${pageContext.request.contextPath}/assets/css/datatables.min.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/assets/css/datatables.material.min.css" rel="stylesheet">
<script src="${pageContext.request.contextPath}/assets/js/datatables.min.js" type="text/javascript"></script>
